'use strict'
var precacheConfig = [],
    cacheName = 'sw-precache-v3-next-demo-' + (self.registration ? self.registration.scope : ''),
        ...
        return (function e(t, n, r) {
        ...
        })(
            {
                1: [
                    function(e, t, n) {
                        function r(e, t) {
                            ;((t = t || {}).debug || s.debug) && console.log('[sw-toolbox] ' + e)
                        }
                        function o(e) {
                            var t
                            return e && e.cache && (t = e.cache.name), (t = t || s.cache.name), caches.open(t)
                        }
                        function i(e, t, n) {
                            var o = e.url,
                                i = n.maxAgeSeconds,
                                ...
                                s = Date.now()
                            return (
                                r('Updating LRU order for ' + o + '. Max entries is ' + a + ', max age is ' + i),
                                u
                                    .getDb(c)
                                    .then(function(e) {
                                    ...
                                    .then(function(e) {
                                        return u.expireEntries(e, a, i, s)
                                    })
                                    .then(function(e) {
                        ...
                        t.exports = {
                            ...
                            precache(e) {
                                e instanceof Promise || a(e), (s.preCacheItems = s.preCacheItems.concat(e))
                            },
                        ...
                        t.exports = {
                                        ...
                                        (s[e] = (function(e) {
                                            return new Promise(function(t, n) {
                                                ...
                                                ;(s.onupgradeneeded = function() {
                                                    s.result.createObjectStore(i, { keyPath: a }).createIndex(c, c, { unique: !1 })
                                                }),
                            ...
                            setTimestampForUrl(e, t, n) {
                                return new Promise(function(r, o) {
                                    ...
                                    a.objectStore(i).put({ url: t, timestamp: n }),
                                        ...
                                        return t
                                            ? new Promise(function(n, r) {
                                                  ...
                                                  ;(h.count().onsuccess = function() {
                                                      var e = f.result
                                                      e > t &&
                                                          (h.openCursor().onsuccess = function(n) {
                                                              var r = n.target.result
                                                              if (r) {
                                                                  var i = r.value[a]
                                                                  o.push(i), u.delete(i), e - o.length > t && r.continue()
                                                              }
                                                          })
                                                  }),
                        ...
                        var r = new URL('./', self.location).pathname,
                            ...
                            i = function(e, t, n, i) {
                                t instanceof RegExp
                                    ...
                                    : (0 !== t.indexOf('/') && (t = r + t), (this.keys = []), (this.regexp = o(t, this.keys))),
                                    (this.method = e),
                                    (this.options = i),
                                    (this.handler = n)
                            }
                            ...
                            (a.prototype.add = function(e, t, n, i) {
                                ...
                                ;(i = i || {}),
                                    t instanceof RegExp
                                        ? (a = RegExp)
                                        : (a =
                                              (a = i.origin || self.location.origin) instanceof RegExp
                                                  ? a.source
                                                  : (function(e) {
                                                        return e.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&')
                                                    })(a)),
                            ...
                            return (
                                ...
                                new Promise(function(i, a) {
                                    var c = !1,
                                        ...
                                        u = function(e) {
                                            s.push(e.toString()),
                                                c ? a(new Error('Both cache and network failed: "' + s.join('", "') + '"')) : (c = !0)
                                        },
                                        h = function(e) {
                            ...
                            return (
                                ...
                                o.openCache(n).then(function(t) {
                                    ...
                                    var f = o
                                        ...
                                        .catch(function(r) {
                                            return (
                                                o.debug('Network or response error, fallback to cache [' + e.url + ']', n),
                                                t.match(e).then(function(e) {
                                                    if (e) return e
                                                    if (s) return s
                                                    throw r
                ...
                15: [
                    function(e, t, n) {
                        function r(e, t) {
                            for (var n, r = [], o = 0, i = 0, a = '', u = (t && t.delimiter) || '/'; null != (n = d.exec(e)); ) {
                                var h = n[0],
                                    f = n[1],
                                    l = n.index
                                ...
                                for (var a = '', c = n || {}, s = (r || {}).pretty ? o : encodeURIComponent, u = 0; u < e.length; u++) {
                                    ...
                                    if ('string' != typeof h) {
                                        ...
                                        if (p(l)) {
                                            if (!h.repeat)
                                                throw new TypeError(
                                                    'Expected "' + h.name + '" to not repeat, but received `' + JSON.stringify(l) + '`'
                                                )
                                            if (0 === l.length) {
                                            ...
                                            for (var d = 0; d < l.length; d++) {
                                                ...
                                                a += (0 === d ? h.prefix : h.delimiter) + f
                                            }
                                        } else {
                                            if (((f = h.asterisk ? i(l) : s(l)), !t[u].test(f)))
                                                throw new TypeError(
                                                    'Expected "' + h.name + '" to match "' + h.pattern + '", but received "' + f + '"'
                                                )
                                            a += h.prefix + f
                                        }
                                    } else a += h
                        ...
                        function f(e, t, n) {
                            ...
                            for (var r = (n = n || {}).strict, o = !1 !== n.end, i = '', a = 0; a < e.length; a++) {
                                ...
                                if ('string' == typeof s) i += c(s)
                                    ...
                                    t.push(s),
                                        s.repeat && (l += '(?:' + f + l + ')*'),
                                        (i += l = s.optional ? (s.partial ? f + '(' + l + ')?' : '(?:' + f + '(' + l + '))?') : f + '(' + l + ')')
                                }
                            }
                            var d = c(n.delimiter || '/'),
                                m = i.slice(-d.length) === d
                            return (
                                r || (i = (m ? i.slice(0, -d.length) : i) + '(?:' + d + '(?=$))?'),
                                (i += o ? '$' : r && m ? '' : '(?=' + d + '|$)'),
